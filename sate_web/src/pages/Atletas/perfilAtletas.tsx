...
const PerfilAtleta = ({ onBack, onEdit, onClipes }: PerfilAtletaProps) => {
        ...
        <div className={styles.page}>
            ...
            <div className={styles.profileCard}>
                <div className={styles.profileInfo}>
                    <div className={styles.avatarLarge}>{atleta.iniciais}</div>
                ...
                <div className={styles.performanceIndex}>
                    <span className={styles.indexValue}>{atleta.indiceDesempenho}%</span>
                    <span className={styles.indexLabel}>Índice de desempenho</span>
                </div>
            </div>

            <div className={styles.actionsRow}>
                <button className={styles.actionButton} onClick={onEdit}>
                    <Edit size={16} /> Editar atleta
                </button>
                <button className={styles.actionButton}>
                    <Info size={16} /> Ver informações do atleta
                </button>
                <button className={styles.actionButton}>
                    <Play size={16} /> Ver partidas
                </button>
                <button className={styles.actionButton} onClick={onClipes}>
                    <Video size={16} /> Ver todos os clipes
                </button>
            </div>
                    ...
                    <div className={styles.chartContainer}>
                        <svg viewBox="0 0 200 200" className={styles.radarChart}>
                            ...
                            <polygon
                                ...
                                fill="rgba(52, 152, 219, 0.3)" stroke="#3498db" strokeWidth="2"
                            />
